...
const layers = [
  ...
  {
    ...feasibilityLayers[1],
    body: "The local and national policy that decides whether your scheme is viable, and the constraints that bite: Article 4, density caps, and change-of-use thresholds.",
  ...
  {
    ...feasibilityLayers[4],
    body: "The space the building can actually give you: local and national space standards, Building Regulations, and the licensing requirements for that area.",
    image: "/images/generated/layer-density.jpg",
    alt: "Top-down aerial of dense terraced housing streets",
  },
  {
    ...feasibilityLayers[5],
    body: "The part automation cannot do. An architect draws the layout options over your plans, then walks you through them on a video call.",
