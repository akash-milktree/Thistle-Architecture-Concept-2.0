...
const SECTIONS_FALLBACK: LegalSection[] = [
  ...
  {
    heading: "Your Rights",
    body: "Under the UK GDPR, you have the right to access, rectify, or delete your personal data. You can also object to processing, request data portability, and withdraw consent at any time. To exercise these rights, contact us at hello@thistlearchitecture.co.uk. You also have the right to complain to the Information Commissioner's Office, the UK's data protection regulator, at ico.org.uk or on 0303 123 1113, if you are unhappy with how we have handled your information. We would rather you told us first so we can put it right.",
  },
  {
  ...
  },
  {
    ...
    body: "We use third-party services for analytics, email communication and data processing. These providers are contractually bound to process your data only on our instructions and in compliance with UK GDPR. We use Google Analytics to understand how visitors find and use this site, and only if you agree. It sets two cookies, named _ga and _ga_PVDKSFH5GQ. You can accept or refuse when you first arrive, and change your mind at any time using the \"Cookie settings\" link at the bottom of any page. Our cookie policy explains this in full.",
  },
  {
    heading: "Contact Us",
    body: "If you have questions about this Privacy Policy or our data practices, contact us at hello@thistlearchitecture.co.uk or write to Incollective Limited, trading as Thistle Architecture, Gatcombe House, Copnor Road, Hilsea, Portsmouth, PO3 5EJ.",
  },
];
