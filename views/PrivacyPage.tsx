...
const SECTIONS_FALLBACK: LegalSection[] = [
  ...
  {
    heading: "Your Rights",
    body: "Under the UK GDPR, you have the right to access, rectify, or delete your personal data. You can also object to processing, request data portability, and withdraw consent at any time. To exercise these rights, contact us at privacy@thistlearchitecture.co.uk. You also have the right to complain to the Information Commissioner's Office, the UK's data protection regulator, at ico.org.uk or on 0303 123 1113, if you are unhappy with how we have handled your information. We would rather you told us first so we can put it right.",
  },
  {
