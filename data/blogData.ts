...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "## The Economics Work",
      "For developers, the economics of conversion are compelling. Acquisition costs for vacant commercial buildings remain well below residential land values in most locations. Construction costs for conversion are typically 30 to 40% lower than new-build, and the build programme is significantly shorter, often 6 to 9 months from start on site to practical completion.",
