...
const originalPosts: BlogPost[] = [
  {
    ...
    content: [
      "One of the most common questions we hear from developers looking at commercial-to-residential conversions is whether to pursue Class MA permitted development rights or submit a full planning application. The answer, as with most things in property development, depends on the building.",
      "## What is Class MA?",
      ...
      "In our experience, prior approval applications for straightforward buildings succeed more often than comparable full applications, and decisions arrive faster: most prior approvals are determined within the 56-day statutory window, while full planning routinely takes 12 to 16 weeks.",
      ...
      "The critical thing is to make this decision early, before you exchange contracts. Our [feasibility reports](/feasibility-package) include a clear recommendation on the optimal planning route, backed by local precedent analysis and a risk assessment for each option.",
    ],
    image: "/images/projects/greyfriars-option2-1.png",
  ...
  },
  {
    ...
    content: [
      ...
      "## The Bottom Line",
      "A feasibility report should be the hardest-working document in your acquisition process. If it doesn't give you the clarity to make a confident decision, to bid, to walk, or to negotiate, it's not doing its job. Our [reports](/feasibility-package) are designed to be the single document you need to make that call.",
    ],
    image: "/images/generated/report-hands.jpg",
  ...
  },
  {
    ...
    excerpt: "High office vacancy, supportive planning policy, and a chronic housing shortage are creating the perfect conditions for conversion projects.",
    content: [
      ...
      "That's exactly what Thistle is built for. Our [5-day feasibility process](/feasibility-package) is designed to give developers the speed and clarity they need to act on deals before the competition catches up.",
    ],
