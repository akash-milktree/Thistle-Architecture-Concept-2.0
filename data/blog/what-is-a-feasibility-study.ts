...
export const post: BlogPost = {
  ...
  content: [
    ...
    "Reports vary widely across the industry, in both scope and quality. Ours contains six deliverables, and we would argue any credible feasibility study should include the same:",
    "- GA floor plans: general arrangement drawings showing the proposed layout of each floor, drawn to scale so the unit sizes are real rather than hopeful.",
    ...
    "- Constraints analysis: a review of every planning and physical constraint on the site, from use class and Article 4 directions to flood risk and heritage designations.",
    ...
    "There is also the cost of delay. Good buildings sell quickly, and a developer who needs six weeks to assess one will keep losing deals to a developer who needs five days. Our [feasibility package](/feasibility-package) is a fixed fee from £1,800, takes five working days, and includes all six deliverables listed above.",
    "## Frequently Asked Questions",
    "### How much does a property feasibility study cost?",
    "Fees vary with the size and complexity of the building. Our fixed fee starts at £1,800 and covers all six deliverables, including the Go/No-Go recommendation. Set against the sums at risk on even a small conversion, it is a small fraction of the exposure.",
