...
export const post: BlogPost = {
  slug: "top-10-considerations-when-it-comes-to-self-building",
  title: "How to Build Your Own House: Top 10 Considerations For Self Builders",
  excerpt: "To help you on your way to planning your self build, here are 10 self build considerations in this guide on how to build your own house.",
  content: [
    ...
    "In general, you will need to search for local land auctions in your area, or national online auctions, such as [nationalpropertyauctions.co.uk](http://nationalpropertyauctions.co.uk) or [sdlauctions.co.uk](http://sdlauctions.co.uk), that usually take place at a scheduled date and time. It is a great way to find land for sale at reduced cost in some cases.",
    "### Estate & Land Agents",
    ...
    "[Searching for “land agents”](https://www.google.co.uk/search) in your local area should bring up some local results of property and land agents.",
    "### Online Platforms",
    "There are online methods to locate land for sale. Some popular places to start are [Plotsearch](https://plotsearch.buildstore.co.uk/findingland/) and [AddLand](https://addland.com/). These are online property databases and you can register to browse land for sale in your local area or area of interest.",
    ...
    "- [Help to Build Equity Loan](https://www.ownyourhome.gov.uk/scheme/help-to-build/)",
    "We put together a handy guide on [How to Fund a Self Build](/blog/how-to-fund-a-self-build-home) that can help you understand your options in more detail.",
    "You can also explore our article on [How Much Self Builds Cost](/blog/how-much-does-it-cost-to-self-build-in-2023) to help you work out budgeting.",
    ...
    "Our blog on[how to find the right self build architect](/blog/how-to-find-the-right-self-build-architect) should give you some helpful tips when it comes to looking for a suitable architect for your self build project.",
    ...
    "[Pros and Cons of Timber Frame in Self Building >](/blog/self-build-timber-frame-house)",
    "### 2. Brick and Block",
    ...
    "[Pros and Cons of Masonry in Self Building >](/blog/10-pros-and-cons-of-masonry-for-self-build-houses)",
    ...
    "[Pros and Cons of ICFs in Self Building >](/blog/self-build-icfs-construction)",
    ...
    "[Pros and Cons of SIPs in Self Building >](/blog/self-build-sips-construction)",
    "![](/images/blog/inline/top-10-considerations-when-it-comes-to-self-building-2-52d13fcb.jpg)",
    ...
    "- [Full Application](https://www.planningportal.co.uk/planning/planning-applications/consent-types/full-planning-consent) - This is the most common type and entails all details of the project being submitted with the application, including drawings and site plans.",
    "- [Outline Application](https://www.planningportal.co.uk/planning/planning-applications/consent-types/outline-planning-consent) - Usually for larger development projects, this application types requires less detail and is rather to get a gauge as to whether a proposed project could be viable before making detailed plans.",
    "- [Householder Application](https://www.planningportal.co.uk/planning/planning-applications/consent-types/householder-planning-consent) - This is for people wanting to carry out extensions or work in their home and garden area.",
    "- [Reserved Matters Application](https://www.planningportal.co.uk/planning/planning-applications/consent-types/reserved-matters) - After Outline permission is granted, this application is for approval of the details that follow. I.e. information that was missing from the initial plan.",
    ...
    "As stated on the [gov.uk](http://gov.uk)[website](https://www.gov.uk/planning-permission-england-wales):",
    ...
    "FMB’s Find a Builder service can be a good place to start searching for builders: [https://www.fmb.org.uk/find-a-builder.html](https://www.fmb.org.uk/find-a-builder.html). Furthermore, speaking to other self-builders can be another good way to find potentially valuable tradesman.",
    ...
    "- [SelfBuild Insurance](https://www.selfbuild.uk.com/)",
    "- [Zurich Self Build Insurance](https://www.zurich.co.uk/insurance/self-build-insurance)",
    "- [ProAcktive Self Build Insurance](https://www.selfbuildinsure.co.uk/self-build-insurance)",
    "- [Self Build Zone Insurance](https://www.selfbuildzone.com/)",
    "- [Protek Self Build Site Insurance](https://www.protekselfbuild.co.uk/site-insurance/)",
    "- [Rennovation Plan Self Build Insurance](https://www.renovationplan.co.uk/what-we-cover/self-build-insurance/)",
