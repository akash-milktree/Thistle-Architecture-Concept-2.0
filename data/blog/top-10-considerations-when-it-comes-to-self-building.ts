...
export const post: BlogPost = {
  ...
  excerpt: "When researching everything you need to consider when planning your own self build project, there is an overwhelming amount of information online.",
  content: [
    "When researching everything you need to consider when planning your own self build project, there is an overwhelming amount of information online and it can be difficult to know exactly where to start. To help you on your way to building your own home, we have pulled together this handy guide highlighting all the top 10 considerations and areas you'll need to research when understanding how to self build a house.",
    ...
    "- SelfBuild Insurance",
    "- Zurich Self Build Insurance",
    "- ProAcktive Self Build Insurance",
    "- Self Build Zone Insurance",
    "- Protek Self Build Site Insurance",
    "- Rennovation Plan Self Build Insurance",
    "Further to the insurance, you should also spend time understanding self build warranties to protect everything that happens after the self build is complete. A self build warranty can generally cover your home 10 to 12 years after the project completion, depending on the policy you take out. Some of the above insurers also offer self build warranties.",
