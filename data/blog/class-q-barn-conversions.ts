...
export const post: BlogPost = {
  ...
  excerpt: "Unlock the potential of Class Q Barn Conversions with expert guidance. Learn the ins and outs of turning barns into beautiful homes.",
  content: [
    ...
    "![class q barn conversion](/images/blog/inline/self-building-an-eco-home-in-the-uk-2-771f4620.jpg)",
    ...
    "- [Article 2(3) land](https://www.legislation.gov.uk/uksi/2015/596/schedule/1/part/1/made)",
    "- Sites of special scientific interest",
    "- Safety hazard areas",
    "- Listed buildings",
    "- Military explosives storage area",
    "### Floorspace",
    "There was an [amendment to Class Q in 2018](https://www.legislation.gov.uk/uksi/2018/343/article/10/made) which made a distinction between what floorspace is permitted in terms of larger and smaller dwelling houses. In this case, “larger” refers to dwelling above 100 square metres and “smaller” refers to those below 100 square metres. Here are some of the restrictions:",
    ...
    "[Agricultural tenancy](https://www.gov.uk/guidance/agricultural-tenancies) matters involve legal agreements and regulations related to the leasing or renting of agricultural land and buildings. If the site is occupied under agricultural tenancy, Class Q can only proceed with the permission of both the landlord and the tenant who is farming the land or using the building.",
    "### Permitted Works",
  ...
  image: "/images/projects/stanmore-option-a-1.webp",
  date: "July 25, 2024",
