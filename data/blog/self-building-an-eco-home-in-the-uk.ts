...
export const post: BlogPost = {
  ...
  content: [
    ...
    "- Domestic Renewable Heat Incentive (RHI): closed to new applicants in 2022. It paid a financial incentive towards heat pumps, biomass boilers and solar thermal systems, and is mentioned here only because older guides still point at it.",
    "- [Boiler Upgrade Scheme:](https://www.gov.uk/apply-boiler-upgrade-scheme) the current replacement for the RHI in England and Wales, offering a grant towards a heat pump. Check the published grant amount before you budget: it has been raised since the scheme opened and the figure quoted in older articles is usually out of date.",
