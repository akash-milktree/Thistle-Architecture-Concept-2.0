...
export const post: BlogPost = {
  ...
  content: [
    ...
    "We work closely with lenders, Mortgage providers, and brokers to give our clients the best opportunities when it comes to financing their build. See below a link to Windsor Hill mortgages who one of our partners and an award winning, family-run mortgage advice firm that advises anywhere in the UK.",
    "## Word of Mouth",
