...
export const post: BlogPost = {
  ...
  content: [
    ...
    "### Budget & Fees",
    "Getting an idea of how their fees work will be a critical part of your decision making process. Make sure that when you get your quote for the project, you are clear about hidden [self build costs](/blog/how-much-does-it-cost-to-self-build-in-2023) and can gauge exactly how their process works within your budget.",
    "### Get Multiple Quotes",
