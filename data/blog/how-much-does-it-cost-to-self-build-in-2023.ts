...
export const post: BlogPost = {
  ...
  excerpt: "The amount of money that it can cost to self build a home can vary massively depending on what sort of self build project you are planning.",
  content: [
    ...
    "- Checkatrade (per m2): Estimates £1,400 - £3,000 | Average Cost: £1,800",
    "- My Builder (per m2): Estimates £1,500 - £3,000 | £140 to £280 per square foot",
    ...
    "The cost of self-build land can vary depending on the area of land you want to purchase as well as where the land is located. One great way to get a gauge of plot costs is to try out plotfinder.net or plotbrowser.com. These are large online marketplaces for plots of land throughout the UK. Using a tool like this can help you gain an understanding of rough plot prices in different areas throughout the country.",
    ...
    "Expect to pay around 7-15% of the total self build cost involving design and supervision.",
