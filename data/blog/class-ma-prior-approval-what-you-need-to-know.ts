...
export const post: BlogPost = {
  slug: "class-ma-prior-approval-what-you-need-to-know",
  title: "Class MA Prior Approval: What You Need to Know",
  excerpt: "Discover everything you need to know about Class MA Prior Approval, including eligibility criteria, application requirements, and key considerations for your project.",
  content: [
    ...
    "These changes were brought forward through the [Town and Country Planning (General Permitted Development) (England) (Amendment) Order 2024 [SI 2024 No. 141]](https://www.legislation.gov.uk/uksi/2024/141/contents/made), removing some restrictions and making Class MA easiest and more attractive to developers seeking to convert these commercial spaces into residential homes.",
    ...
    "- Floorspace Limits: The previous cap of 1,500 square meters [was lifted in March 2024](https://www.fladgate.com/insights/permitted-development-update-class-ma-commercial-to-residential-restrictions-removed), meaning that developers can repurpose commercial buildings of any size. This creates a fantastic opportunity to deliver larger-scale residential projects and significantly increase the number of units provided.",
