...
export const post: BlogPost = {
  slug: "10-pros-and-cons-of-masonry-for-self-build-houses",
  title: "10 Pros and Cons of Masonry for Self Build Houses",
  excerpt: "Masonry is a popular, traditional self build construction method. This article outlines the pros and cons of masonry for self builds.",
  content: [
    ...
    "![brick and block house](/images/blog/inline/10-pros-and-cons-of-masonry-for-self-build-houses-1-181fffd7.jpg)",
    "## What is ‘Brick and Block’ Construction in Self Building?",
    "Masonry or ‘brick and block’ construction is perhaps the most well known and established construction method. Masonry is one of the oldest trades in recorded history, and has been used for over 6,000 years according to [Soumar](https://www.soumar.com/blog/early-examples-of-masonry/).",
    ...
    "![stone house masonry construction self build](/images/blog/inline/10-pros-and-cons-of-masonry-for-self-build-houses-2-6ba377d6.jpg)",
    ...
    "![brick and block construction self build](/images/blog/inline/brick-vs-stone-vs-concrete-masonry-in-self-build-homes-2-536ebdad.jpg)",
