...
//
// Documents open in a new tab rather than a modal. The browser's own PDF view
// gives page turning, zoom, search, print and download, and keeping the case
// study open behind it means the reader does not lose their place.
