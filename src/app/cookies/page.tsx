...
const load = cache(() => client.queries.legal({ relativePath: 'cookies.json' }));
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    title: str(data.legal.metaTitle) || 'Cookie Policy',
    description: str(data.legal.metaDescription) || 'Thistle Architecture cookie policy.',
...
export default async function Page() {
  ...
  return <CookiesPage page={{ query: legal.query, variables: legal.variables, data: legal.data }} />;
}
