...
const load = cache(() => client.queries.legal({ relativePath: 'terms.json' }));
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    title: str(data.legal.metaTitle) || 'Terms of Service',
    description: str(data.legal.metaDescription) || 'Thistle Architecture terms of service.',
...
export default async function Page() {
  ...
  return <TermsPage page={{ query: legal.query, variables: legal.variables, data: legal.data }} />;
}
