...
const RELATIVE_PATH = 'hmo-calculator.json';
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: { absolute: t?.metaTitle || tool?.metaTitle || 'HMO Valuation Calculator | Thistle Architecture' },
...
export default async function Page() {
  ...
  return <HMOCalculatorPage page={{ query: doc.query, variables: doc.variables, data: doc.data }} />;
}
